/* from https://raw.githubusercontent.com/cseagle/sk3wldbg/master/teb32.h */
//
...
typedef struct LIST_ENTRY_ *LIST_ENTRY_p;
...
typedef struct RTL_CRITICAL_SECTION_ *RTL_CRITICAL_SECTION_p;
...
typedef struct RTL_CRITICAL_SECTION_DEBUG_ *RTL_CRITICAL_SECTION_DEBUG_p;
...
typedef struct EXCEPTION_RECORD_ *EXCEPTION_RECORD_p;
...
typedef struct CONTEXT_ *CONTEXT_p;
...
typedef struct EXCEPTION_REGISTRATION_ *EXCEPTION_REGISTRATION_p;
...
typedef struct ExceptionHandler_ *ExceptionHandler_p;
typedef struct EXCEPTION_REGISTRATION_ *EXCEPTION_REGISTRATION_p;
...
typedef struct PEB_FREE_BLOCK_ *PEB_FREE_BLOCK_p;
...
typedef struct PEB_LDR_DATA_ *PEB_LDR_DATA_p;
typedef struct RTL_USER_PROCESS_PARAMETERS_ *RTL_USER_PROCESS_PARAMETERS_p;

typedef struct ACTIVATION_CONTEXT_DATA_ *ACTIVATION_CONTEXT_DATA_p;
typedef struct ASSEMBLY_STORAGE_MAP_ *ASSEMBLY_STORAGE_MAP_p;
typedef struct ACTIVATION_CONTEXT_DATA_ *ACTIVATION_CONTEXT_DATA_p;
typedef struct ASSEMBLY_STORAGE_MAP_ *ASSEMBLY_STORAGE_MAP_p;

typedef struct FLS_CALLBACK_INFO_ *FLS_CALLBACK_INFO_p;
...
typedef struct TEB_ACTIVE_FRAME_ *TEB_ACTIVE_FRAME_p;
typedef struct TEB_ACTIVE_FRAME_CONTEXT_ *TEB_ACTIVE_FRAME_CONTEXT_p;
...
typedef struct PEB_ *PEB_p;
typedef struct TEB_ *TEB_p;
typedef struct TEB_ACTIVE_FRAME_ *TEB_ACTIVE_FRAME_p;
